  ...
  <header id="header">
    <div class="container">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          <li class="menu-active"><a href="home.php">Acuiel</a></li>
...
<nav aria-label="breadcrumb">
  <div class="container">
  <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="home.php">Acuielle</a></li>
...
<div class="container">
<div class="jumbotron">
  <h1 class="display-4">Votre Compte a été créé</h1>
  <p class="lead">Vous pouvez accéder à votre compte et compléter votre demande . </p>
  <hr class="my-4">
  <a class="btn btn-primary btn-lg" href="home.php" role="button">Retour</a>
</div>
</div>
