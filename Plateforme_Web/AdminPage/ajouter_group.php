...
$m1="INSERT INTO `group`(`id_group`, `nom_group`) VALUES ($id,'$nom')";
            ...
            <section class="panel">
              ...
              <div class="panel-body">
                <form role="form" action="<?php echo $_SERVER['SCRIPT_NAME']; ?>" method="post">
                  ...
                  <div class="form-group">
                    <label for="exampleInputPassword1">Nom De Group</label>
                    <input type="text" class="form-control"  placeholder="Entrer Le Nom de Group"  name="nom">
                  </div>
