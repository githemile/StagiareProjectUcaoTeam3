              ...
              <div class="panel-body">
                <form role="form" action="<?php echo $_SERVER['SCRIPT_NAME']; ?>" method="post">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control"  placeholder="Entrer Le sujet de Group"  name="sujet">
                  </div>
                   <div class="form-group">
                    <label for="exampleInputPassword1">Date de debut de Stage</label>
                    <input type="date" class="form-control"  placeholder="Entrer La date de debut de Group"  name="debut">
                  </div>
                   <div class="form-group">
                    <label for="exampleInputPassword1">Date de fin de Stage</label>
                    <input type="date" class="form-control"  placeholder="Entrer La date de fin de Group"  name="fin">
                  </div>
                 <div class="form-group">
                    <label for="exampleInputPassword1">CIN de L`Encadrant</label>
                    <input type="text" class="form-control"  placeholder="Entrer Le CIN de l'encandrant de Group"  name="cin_enc">
                  </div>
