...
//$dis=$_FILES['mon_fichier']['tmp_name'];
//echo ftp_put($conn_id,"recu2.txt",$dis,FTP_ASCII);
echo ftp_get($conn_id,$fichier,$fichier,FTP_ASCII);
...
<section id="main-content">
 ...
 <center><font color=\"#FF0000\"><h1>le fichier a ete envoyer</h1></font></center> ";
