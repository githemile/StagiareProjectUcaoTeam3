...
<table class="table">
  ...
  <tbody>
     <tr>
      <th scope="row">Nom </th>
      <td><?php echo $nom ?></td>
        <th><div class="float-right"><button type="button" class="btn btn-outline-success"><a href="modifier_compte.php?var=nom">Modifier</a></button></div></th>
    </tr>
    <tr>
      <th scope="row">Prenom</th>
      <td><?php echo $prenom ?></td>
       <th><div class="float-right"><button type="button" class="btn btn-outline-success"><a href="modifier_compte.php?var=prenom">Modifier</a></button></div></th>
    <tr>
      <th scope="row">CIN</th>
      <td><?php echo $cin ?></td>
       <th><div class="float-right"><button type="button" class="btn btn-outline-success"><a href="modifier_compte.php?var=cin">Modifier</a></button></div></th>
    </tr>
    <tr>
      <th scope="row">Nom d`utilisateur</th>
      <td><?php echo $nomm ?></td>
       <th><div class="float-right"><button type="button" class="btn btn-outline-success"><a href="modifier_compte.php?var=nom_d_utilisateur">Modifier</a></button></div></th>
    </tr>
    <tr>
      <th scope="row">Mail</th>
      <td><?php echo $mail ?></td>
     <th><div class="float-right"><button type="button" class="btn btn-outline-success"><a href="modifier_compte.php?var=mail">Modifier</a></button></div></th>
    </tr>
     <tr>
      <th scope="row"></th>
      <td></td>
