            ...
            Operation
              ...
              <div class="panel-body">
                <div class="btn-group btn-group-justified">
                  <a class="btn btn-primary" href="modifier_stagiaire.php" >Modifier</a>
                  <a class="btn btn-info" href="note.php">Donner la note de Stage</a>
                 <a class="btn btn-warning" href="fichier.php">les fichiers  recu</a>
                </div>
              </div>
            </section>
    <header class="panel-heading">
