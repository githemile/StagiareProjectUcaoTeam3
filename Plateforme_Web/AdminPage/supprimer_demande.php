...
if (isset($_GET['var'])) {
$cin=$_GET['var'];
$m2="DELETE FROM `stagiaire` WHERE cin='$cin' ";
$resultat2=mysqli_query($connexion,$m2);
if ($resultat2==1) {
  echo " <center><font color=\"#FF0000\"><h1>La Demande a été supprimer!</h1></font></center> ";
}else
{
echo " <center><font color=\"#FF0000\"><h1>Error Réessayer!</h1></font></center> ";
}
