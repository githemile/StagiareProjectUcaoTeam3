        ...
        <div class="row">
          <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
            <div class="info-box green-bg">
              ...
              <div class="count"><?php echo $nb_stagiaire ?></div>
              <div class="title"><h3>Stagiaire(s) en cours</h3></div>
            </div>
            <!--/.info-box-->
          </div>
          <!--/.col-->
          <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
            <div class="info-box blue-bg">
              ...
              <div class="count"><?php echo $nb_demande ?></div>
              <div class="title"><h3>Demande(s) de Stage</h3></div>
            </div>
            <!--/.info-box-->
          </div>
          <!--/.col-->
          ...
          <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
            <div class="info-box brown-bg">
              <i class="fa fa-cubes"></i>
              <div class="count"><?php echo $nb_stage ?></div>
              <div class="title"><h3>Stage(s)   en cours</h3></div>
            </div>
            <!--/.info-box-->
          </div>
          <!--/.col-->
          ...
          <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
            <div class="info-box dark-bg">
              <i class="fa fa-cubes"></i>
              <div class="count"><?php echo $nb_enc ?></div>
              <div class="title"><h3>Encadrant(s)</h3></div>
            </div>
            <!--/.info-box-->
          </div>
          <!--/.col-->
