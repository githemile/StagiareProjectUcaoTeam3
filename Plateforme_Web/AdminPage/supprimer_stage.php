...
$m1="DELETE FROM `stage` WHERE `id_stage`=$id";
$resultat1=mysqli_query($connexion,$m1);


 if ($resultat1==1) {
  echo " <center><font color=\"#FF0000\"><h1>Suprimer</h1></font></center> ";
 }else{
          ...
          <div class="col-lg-6">
            <section class="panel">
              <header class="panel-heading">
                Supprimer Stage (Sujet)
              </header>
              <div class="panel-body">
                <form role="form" action="<?php echo $_SERVER['SCRIPT_NAME']; ?>" method="post">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Numero de Stage</label>
                    <input type="text" class="form-control"  placeholder="Enter Id de Group" name="id_stage">
                  </div>
