        ...
        <div class="container">
          <div class="navbar-header">
            ...
            <div class="navbar-brand">
             <a href="index.html"><img src="images/Ocp2.png" width="100" height="100"></a>
             <!-- <img src="Ocp.jpg">-->
            </div>
          </div>
          ...
          <div class="navbar-collapse collapse">
            <div class="menu">
              <ul class="nav nav-tabs" role="tablist">
                <li role="presentation"><a href="home.php" >Accueil</a></li>
                ...
                <li role="presentation"><?php if (isset($_SESSION['username'])) {
                 ...
                 }else{ echo "<a href=\"login.php#login\">Connexion</a>";}  ?></li>
